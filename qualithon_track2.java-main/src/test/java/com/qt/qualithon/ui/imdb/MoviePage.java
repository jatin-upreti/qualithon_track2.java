...
public class MoviePage extends Page{
    ...
    public List<String> genres(){
        ...
        List<WebElement> genre=this.testSession.driverWait().until(
        		ExpectedConditions.presenceOfAllElementsLocatedBy(
        				By.cssSelector("div[class='ipc-chip-list sc-14389611-4 ctpXmw']")));
        
        for(WebElement gen:genre){
            try{
                
                    List<WebElement> genreElements = gen.findElements(By.cssSelector("a"));
